        ...
        else
        {
          ...
          echo "<tr><td>";
           ...
           echo "<td><input type='checkbox' name='item1' id='item1' onclick='enablef();'></td>
                    <td class='check'><input type='number' min='1' max='10' name='item1qty' id='item1qty' placeholder='Enter Quantity' style='display:none;'><span class='error' style='background-color: red'>".$q1Err."</span></td></tr></div>";
        }
       ...
       $result1=$stmt->execute();
        ...
        else
        {
          ...
          echo "<img src='PawCart/$row[0]' height='150' width='150'>"."</td><td>".$row[1]."</td><td>".$row[2]."</td>";
           ...
           <td class='check'><input type='number' min='1' max='10' name='item11qty' id='item11qty' placeholder='Enter Quantity' style='display:none;'><span class='error' style='background-color: red'>".$q11Err."</span></td></tr></div>";
        }
    echo "</table>";
